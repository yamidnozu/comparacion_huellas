...
console.log(valoresNoValidos);
console.log(valoresValidosAComparar);
console.log('_______________');
...
function agregarParte(h1, s, _s, expRegular, valoresValidosAComparar, i) {
    ...
    expT2 = `[${valoresValidosAComparar[i]}]{1}.*`;
    const auxExpRegularIncluyeCaracter = expRegular + expT1;
    const auxExpRegularIgnoraCaracter = expRegular + expT2;
    ...
    if (expReg.test(h1)) {
        ...
        // expRegular += auxExpRegularIgnoraCaracter;
    }
